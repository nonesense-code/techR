...
function LaptopBlog() {
  ...
  const [targetLaptop, setTargetLaptop] = useState({});
  ...
  useEffect(() => {
    const fetchTargetLaptop = async () => {
      try {
        ...
        setTargetLaptop(response.data);
        // Debugging: Check if the effect is triggered
        console.log("Target laptop data fetched, scrolling to top...");
        setTimeout(() => {
          window.scrollTo({
            top: 0,
            behavior: "smooth",
                ...
                <div className="flex flex-col md:flex-row items-center justify-around gap-4 p-4">
                  ...
                  <div className="w-full md:w-1/2 flex flex-col gap-6 p-2 text-2xl text-[#002] border-2 border-black rounded-xl">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[18px]">{targetLaptop.memory}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="flex items-center gap-1 bg-zinc-400 p-2 rounded-lg">
                        <FaMicrochip />
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[18px]">{targetLaptop.camera}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="flex items-center gap-1 bg-zinc-400 p-2 rounded-lg">
                        <GiBattery100 />
